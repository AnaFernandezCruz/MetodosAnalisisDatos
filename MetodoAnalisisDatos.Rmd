...
```{r warning=FALSE}
    ...
    (na_counts_sort)
    train_test_na <- train %>% dplyr::select(LotFrontage, GarageYrBlt, MasVnrType, MasVnrArea, MSZoning, Functional, Exterior1st, Exterior2nd, Electrical, BsmtFinSF1, BsmtFinSF2, BsmtUnfSF, KitchenQual, TotalBsmtSF, BsmtFullBath, BsmtHalfBath, GarageCars, GarageArea, SaleType)
...
train_test_na<- dplyr::select(train_test_na, -LotFrontage)
