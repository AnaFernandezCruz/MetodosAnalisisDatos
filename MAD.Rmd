...
#      if(i %in% c('SalePrice'))   {
#          outliersRosen <- rosnerTest(train[[i]], k = 3, warn = F)
...
Una vez realizado el estudio, localizamos una serie de variables que son candidatas a **NO** entrar en el modelo. Las columnas que a priori hemos quitado sin justificación, son las siguientes:
...
# quitamos 'GarageQual','hasPool','ExterCond','PoolArea','PoolQC'
# ,'Exterior2nd','HeatingQC','Heating','Electrical','MSSubClass'

# la columna 'Exterior1st' se quita poruqe sino al generar el html falla,
# pero si lo ejecutas desde r funciona correctamente ¿¿??

var_to_remove <- c('GarageQual','hasPool','ExterCond','PoolArea','PoolQC','Exterior2nd','HeatingQC','Heating','Electrical','MSSubClass','Exterior1st','Foundation')
